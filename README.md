...
The robot is often shipped with the SDK, at least this is for my case. You can check with a `ls` of the home folder. If the SDK is missing, you should download it from the official GitHub repo: https://github.com/unitreerobotics/unitree_sdk2. 
